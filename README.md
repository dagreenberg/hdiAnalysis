...
by Andrew M. Edwards and Marie Auger-Méthé, being submitted shortly to
the *Proceedings of the National Academy of Sciences*.

The manuscript (available upon request) should be read first to
...
streamline the calculation of HDIs for time series of MCMC values and to
produce simple summary tables of results.
