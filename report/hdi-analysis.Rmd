...
## Messing around with arrows and bars

HERE: carry on adding arrows (play with options, maybe see grid package arrow
function, can add bar ends) and bars to plot, label the bars A and B, as Marie
was suggesting:

Hardwiring some things to try an tailor the first figure.
```{r arrowsbars}
plot_density(year = 2021,
             type = "equal",
             ylim = c(0, 0.1),
