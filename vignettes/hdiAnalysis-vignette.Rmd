...
`create_intervals()` which, becuase `hake_recruitment_mcmc` has class
...
and then do option to show all density plots

was `plot_series()`, think now make a proper `plot.intervals_density_list()`

TODO dig into warnings
