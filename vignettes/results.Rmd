...
res_vec_long_no_density <- create_intervals(vec_long,
                                             density = FALSE)

res_vec_long$intervals %>% a()
res_vec_long_no_density$intervals %>% a()
...
```{r tableres}
knitr::kable(res_vec$intervals %>% select(median,
                                           eti_lower,
                                           eti_upper,
                                           hdi_lower,
                                           hdi_upper,
