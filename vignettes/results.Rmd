...
of 0.4 is key in forming stakeholders' perception of the health of the hake stock.As seen in the figure, for some years the ETI does not dip below 0.4 but
the HDI does. Thus, the perception of stock status can depend upon the
...
on the values
for 2023 and 2024 which are given in a bullet in the one-page summary of the hake assessment:
...
This is larger than the total 2023 catch of males and females, whereas spawning
biomass only considers spawning females, and so is certainly not trivial. Again,
intervals are shifted downwards, implying the stock biomass is lower than implied
