...
point between the two grey lines to create such ranges `c` and `d`, including at
...
exactly 95%, such that the issue of the HDI not being exactly 95% is not
