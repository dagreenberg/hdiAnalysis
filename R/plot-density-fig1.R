...
plot_density_fig1 <- function(dat_mcmc = one_year_mcmc,
                         ...
                         col_tail_high = rgb(204, 121, 167, maxColorValue = 255), # Reddish purple from color blind pallet (Okabe-Ito)
                         col_included = rgb(230, 159, 0, maxColorValue = 255), # Orange from color blind pallet (Okabe-Ito)
                         main_title = NULL,
                         x_lab = NULL){
